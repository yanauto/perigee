...
[English](README.md) · [简体中文](#) · [更新日志](CHANGELOG.zh-CN.md) · [官网](https://perigee.yan-auto.me) · [X @yanautome](https://x.com/yanautome)
...
0.3.0 做了什么（握手、多会话同步、正式包）见 **[更新日志](CHANGELOG.zh-CN.md)**（[English](CHANGELOG.md)）。
